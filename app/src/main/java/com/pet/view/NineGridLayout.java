...
public abstract class NineGridLayout extends ViewGroup {
    ...
    public void notifyDataSetChanged() {
        ...
        if (size == 1) {
            String url = Const.PIC_URL+mUrlList.get(0);
            RatioImageView imageView = createImageView(0, url);
            //避免在ListView中一张图未加载成功时，布局高度受其他item影响
            LayoutParams params = getLayoutParams();
            params.height = mTotalWidth;
            setLayoutParams(params);
            imageView.layout(0, 0, mTotalWidth, mTotalWidth);
        ...
        for (int i = 0; i < size; i++) {
            String url = Const.PIC_URL+mUrlList.get(i);
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imageBrower(i, (ArrayList<String>) mUrlList);
            }
        });
        return imageView;
    }
