...
public class ImageLoaderUtil {
    ...
    public static DisplayImageOptions getPhotoImageOption() {
        ...
        DisplayImageOptions options = new DisplayImageOptions.Builder().cacheInMemory(true).cacheOnDisk(true)
                .showImageForEmptyUri(R.mipmap.load_pic_fail).showImageOnFail(R.mipmap.load_pic_fail)
    ...
    public static void displayImage(Context context, ImageView imageView, String url, DisplayImageOptions options, io.rong.imageloader.core.listener.ImageLoadingListener imageLoadingListener) {
