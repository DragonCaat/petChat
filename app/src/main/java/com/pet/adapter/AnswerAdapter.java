...
public class AnswerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AnswerAdapter(Context activity, AnswerEntity answerEntity, List<AnswerEntity.CmmtBean> cmmtBeans,OnItemPictureClickListener listener1) {
    ...
    public AnswerAdapter(Context activity, List<AnswerEntity.CmmtBean> cmmtBeans) {
        this.mContext = activity;
        this.cmmtBeans = cmmtBeans;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_TYPE_MAIN) {
            ...
            return new AnswerAdapter.HeadViewHolder(view);
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeadViewHolder) {
            ...
            //Log.i("hello", "onBindViewHolder: "+answerEntity.getUpvote());
            ...
            ((HeadViewHolder) holder).llPoint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (answerEntity.getUpvote() == 0)
                        posts_upvotet(answerEntity.getPost_id(), ((HeadViewHolder) holder).ivPoint,((HeadViewHolder) holder).tvPoint,answerEntity.getUpvoteCount());
                    else
            ...
            ((ViewHolder) holder).llPoint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (cmmtBean.getCmmt_upvote() == 0)
                        sendData(cmmtBean.getCmmt_id(),((ViewHolder) holder).ivPoint,((ViewHolder) holder).tvPoint,cmmtBean.getCmmt_upvoteCount());
                    else
     ...
     * @param cmmt_id 评论的id
     */
    private void sendData(int cmmt_id, final ImageView imageView, final TextView textView, final int cmmtCount) {
        ...
        call.enqueue(new retrofit2.Callback<ResultEntity>() {
            ...
            public void onResponse(Call<ResultEntity> call,
                ...
                if (res == 200) {// 获取成功
                    imageView.setImageResource(R.mipmap.hand_press);
                    int count = cmmtCount+1;
